    ...
    <main className="flex-grow">
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="flex flex-col gap-4 max-w-3xl mx-auto">
          ...
          <h2 className="font-black text-lg mt-4 border-b-2 border-foreground pb-2">What are cookies?</h2>
          <p className="text-foreground/80 font-medium">
          ...
          <h2 className="font-black text-lg mt-4 border-b-2 border-foreground pb-2">Why do we use cookies?</h2>
          <p className="text-foreground/80 font-medium">We use cookies for the following purposes:</p>
          ...
          <h2 className="font-black text-lg mt-4 border-b-2 border-foreground pb-2">Types of cookies we use</h2>
          <p className="text-foreground/80 font-medium">
          ...
          <h2 className="font-black text-lg mt-4 border-b-2 border-foreground pb-2">How to control cookies</h2>
          <p className="text-foreground/80 font-medium">
          ...
          <h2 className="font-black text-lg mt-4 border-b-2 border-foreground pb-2">Changes to this Cookie Policy</h2>
          <p className="text-foreground/80 font-medium">
